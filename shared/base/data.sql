...
-- Insert with SHA-256 hashed passwords
INSERT INTO Admin (Pseudo, MotDePasse) VALUES
    ('admin1', encode(digest('password1', 'sha256'), 'hex')),
    ('admin2', encode(digest('password2', 'sha256'), 'hex')),
    ('admin3', encode(digest('password3', 'sha256'), 'hex'));
