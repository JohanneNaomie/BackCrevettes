...
public class Bilan {
    ...
    public List<StockDepense> getTheoriqueStock(String dateDebut, String dateFin)throws Exception {
        String query = "SELECT " +
    ...
    public List<StockDepense> getReelStock(String dateDebut, String dateFin) throws Exception{
        String query = "SELECT " +
                "    equipement.nom AS type, " +
    ...
    private List<StockDepense> executeQuery(String query, String dateDebut, String dateFin)throws Exception {
